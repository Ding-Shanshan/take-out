...
const orderUseEffect=()=>{
    ...
    return {shopName,shopId,productList,handleBackClick};
}

export default {
     name: 'OrderConfirmation',
     setup(){
        const {shopName,shopId,productList,handleBackClick}=orderUseEffect();
        const {total}=useCommonEffert(shopId);
        return {shopName,shopId,productList,total,handleBackClick};
     }
}
</script>
